...
class Recording extends Backend
{
    ...
    public function initialize(): void
    {
        ...
        $this->voiceModel = new \app\admin\model\broadcast\Propaganda;
    }
        ...
        if ($this->request->isPost()) {
            ...
            try {
                ...
                if ($this->modelValidate) {
                    ...
                    //判断该录音name 是否已经在录音表、音频表数据库中存在
                    $recording = $this->model->where('recording_file_name', $data['recording_file_name'])->find();
                    if ($recording) {
                        $this->error(__('该音频名称已经存在'));
                    }
                    $voice = $this->voiceModel->where('voice_file_name', $data['recording_file_name'])->find();
                    if ($voice) {
                        $this->error(__('该音频名称已经存在'));
                    }
