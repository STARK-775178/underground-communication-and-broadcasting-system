            ...
            <el-container>
                ...
                <el-footer>
                    <div class="centered-buttons">
                        <el-button size="large" @click="emergencyBroadcast" type="danger" round class="button-spacing">全体直播广播</el-button>
...
export default {
    ...
    methods: {
        ...
        // 全体广播按钮
        emergencyBroadcast() {
            // this.dialogBroadcastTitle = '正在进行全体直播广播'
            ...
            // }, 1000)
            // 全体广播记录信息
            this.broadcast.broadcast_type = '直播广播'
            this.broadcast.broadcast_datetime = this.getDateTime()
            // this.broadcast.broadcast_duration = this.formatDuration
            // 进行全体广播呼叫方法
            callApi('3000')
