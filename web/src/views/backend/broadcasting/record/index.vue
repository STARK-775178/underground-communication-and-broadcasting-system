...
const baTable = new baTableClass(
    new baTableApi('/admin/broadcast.BroadcastRecord/'),
    {
        ...
        column: [
            ...
            { label: t('broadcasting.record.broadcast_duration'), prop: 'broadcast_duration', align: 'center', operator: 'RANGE', sortable: false },
            { label: t('broadcasting.record.broadareastable__area'), prop: 'broadAreasTable.area', align: 'center', render: 'tags', operator: false },
            { label: t('broadcasting.record.broadareastable__area'), prop: 'broad_areas', align: 'center', operator: 'FIND_IN_SET', show: false, comSearchRender: 'remoteSelect', remote: { pk: 'cbroad_area.area', field: 'area', remoteUrl: '/admin/device.Area/index', multiple: true } },
