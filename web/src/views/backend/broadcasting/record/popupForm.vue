        ...
        <el-scrollbar v-loading="baTable.form.loading" class="ba-table-form-scrollbar">
            ...
            >
                ...
                >
                    ...
                    <FormItem :label="t('broadcasting.record.broadcast_duration')" type="number" prop="broadcast_duration" :input-attr="{ step: 1 }" v-model.number="baTable.form.items!.broadcast_duration" :placeholder="t('Please input field', { field: t('broadcasting.record.broadcast_duration') })" />
                    <FormItem :label="t('broadcasting.record.broad_areas')" type="remoteSelects" v-model="baTable.form.items!.broad_areas" prop="broad_areas" :input-attr="{ pk: 'cbroad_area.area', field: 'area', 'remote-url': '/admin/device.Area/index' }" :placeholder="t('Please select field', { field: t('broadcasting.record.broad_areas') })" />
...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
    broadcast_duration: [buildValidatorData({ name: 'number', title: t('broadcasting.record.broadcast_duration') })],
