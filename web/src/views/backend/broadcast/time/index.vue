...
let startBroadcastingButton: OptButton[] = [
    {
        ...
        name: 'info',
        // 鼠标放置时的 title 提示
        title: 'broadcast.time.start_broadcasting',
...
const baTable = new baTableClass(
    new baTableApi('/admin/broadcast.Time/'),
    {
        pk: 'task_id',
        column: [
            { type: 'index', align: 'center', operator: false },
            {
                label: t('broadcast.time.task_name'),
                prop: 'task_name',
                align: 'center',
            ...
            { label: t('broadcast.time.start_datetime'), prop: 'start_datetime', align: 'center', operator: 'eq', sortable: 'custom' },
            {
                label: t('broadcast.time.remaining_datetime'),
                render: 'tags',
                prop: 'remaining_datetime',
                align: 'center',
                operator: 'eq',
                sortable: 'custom',
            ...
            // { label: t('broadcast.time.reminder_time'), prop: 'reminder_time', align: 'center', render: 'tags', operator: 'FIND_IN_SET', sortable: false, replaceValue: { opt0: '提前5分钟提醒', opt1: '提前15分钟提醒', opt2: '提前30分钟提醒', opt3: '提前1小时提醒', opt4: '提前2小时提醒', opt5: '提前1天提醒', opt6: '提前2天提醒' } },
            // { label: t('broadcast.time.reminder_method'), prop: 'reminder_method', align: 'center', render: 'tag', operator: 'eq', sortable: false, replaceValue: { opt0: '站内提醒' } },
            {
                label: t('broadcast.time.remark'),
                prop: 'remark',
                align: 'center',
                operatorPlaceholder: t('Fuzzy query'),
                operator: 'LIKE',
            ...
            // { label: t('broadcast.time.create_time'), prop: 'create_time', align: 'center', render: 'datetime', operator: 'RANGE', sortable: 'custom', width: 160, timeFormat: 'yyyy-mm-dd hh:MM:ss' },
            // { label: t('broadcast.time.update_time'), prop: 'update_time', align: 'center', render: 'datetime', operator: 'RANGE', sortable: 'custom', width: 160, timeFormat: 'yyyy-mm-dd hh:MM:ss' },
