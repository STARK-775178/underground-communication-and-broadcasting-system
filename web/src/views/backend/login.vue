<template>
    <div>
        ...
        <div class="login">
            ...
            <div class="login-box">
                <div class="head">
                    <img src="~assets/login-header.png" draggable="false" alt="" />
                </div>

                <div class="form">
                    <img class="profile-avatar" draggable="false" src="~assets/avatar.png" alt="" />
                    <div class="content">
...
const rules = reactive({
    username: [buildValidatorData({ name: 'rezuired', message: t('login.Please enter an account') }), buildValidatorData({ name: 'account' })],
